<?php echo $this->Form->create(null, array( 'url' => DOMAINAD.'image/edit','type' => 'post','enctype'=>'multipart/form-data','name'=>'image',  'inputDefaults' => array('label' => false,'div' => false))); ?>
        ...
        <div class="tab-content default-tab" id="tab1">
            <table width="100%" class="input">
                <tr>
                    ...
                    <td><?php echo $this->Form->input('Image.name',array('value'=> $edit_vie['Image']['name'],'class'=>'text-input medium-input','maxlength' => '250','id' => 'idtitle'));?></td>
                </tr>
                ...
                <tr>
                    <td class="label">&nbsp;</td>
                    <td>
                        <img src="<?php echo IMAGEAD; ?>image/<?php echo $edit_vie['Image']['images']; ?>" height="100">
                        <?php echo $this->Form->input('id', array('type' => 'hidden')); ?>
                        <input name="oldimg" type="hidden" id="imgid" value="<?php echo $edit_vie['Image']['images']; ?>">
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><?php echo $this->Form->input('Image.title_seo',array('label'=>'','class'=>'text-input medium-input','maxlength' => '250','id' => 'idtitle',  'inputDefaults' => array('label' => false,'div' => false)));?></td>
                </tr>
                <tr>
