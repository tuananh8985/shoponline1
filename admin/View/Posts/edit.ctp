    ...
    <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
            <table width="100%" class="input">
               ...
               <tr>
                    <td class="label">Giới thiệu sản phẩm :</td>
                    <td><?php
              ...
              <tr>
                	...
                	<td>
                		<select name="data[Post][display]" id="data[][]">
                			<option <?php if($edit_vie['Post']['display']==1) echo 'selected="selected"';?> value="1">Học Bổng</option>
                			<option <?php if($edit_vie['Post']['display']==2) echo 'selected="selected"';?> value="2">Q & A</option>
                			<option <?php if($edit_vie['Post']['display']==3) echo 'selected="selected"';?> value="3">Tuyển dụng</option>
