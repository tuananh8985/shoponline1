            ...
            <table width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo DOMAINAD ?>tintucs/edit/<?php echo $value['Tintuc']['id']; ?>" title="Edit"><?php echo $value['Tintuc']['name']; ?></a> <?php if(date('Y-m-d', strtotime($value['Tintuc']['modified'])) == date('Y-m-d')) { ?><img src="<?php echo DOMAINAD ?>images/icons/iconnew.gif" alt="New" /><?php } ?></td>
