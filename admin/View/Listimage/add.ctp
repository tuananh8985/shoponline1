<?php echo $this->Form->create(null, array( 'url' => DOMAINAD.'listimage/add', 'type' => 'post', 'name' => 'frm',  'enctype'=>'multipart/form-data', 'inputDefaults' => array('label' => false,'div' => false)));?>
...
<div class="content-box">
    <div class="content-box-header">
        <?php if($tendm['Listimage']['name'] == "") { ?>
        <h3>Thêm danh mục cha</h3>
        <?php } else { ?>
        <h3>Thêm danh mục con của : <?php echo $tendm['Listimage']['name']; ?></h3>
        <?php } ?>
        ...
        <div class="tab-content default-tab" id="tab1">
            <table class="input">
                <tr>
                    ...
                    <td><?php echo $this->Form->input('Listimage.name', array('class'=>'text-input medium-input', 'maxlength' => '250', 'id' => 'idtitle', 'onchange' => 'get_alias()')); ?></td>
                </tr>
				  ...
				  <tr>
                    ...
                    <td><?php echo $this->Form->input('Listimage.alias', array('label' => '', 'class' => 'text-input alias-input', 'maxlength' => '250', 'id' => 'idalias')); ?> <img width="16" height="16" alt="" onclick="get_alias();" style="cursor: pointer; vertical-align: middle;" src="<?php echo DOMAINAD; ?>images/refresh.png"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="radio" value="0" id="CatproductStatus0" name="data[Listimage][status]">
                        Chưa Active 
                        &nbsp;&nbsp;&nbsp;
                        <input type="radio" checked="checked" value="1" id="CatproductStatus1" name="data[Listimage][status]">
                        Đã Active </td>
                </tr>
            </table>
            <div class="clear"></div>
