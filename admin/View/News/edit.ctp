        ...
        <div class="tab-content default-tab" id="tab1">
            <table width="100%" class="input">
                <tr>
                    ...
                    <td><?php echo $this->Form->input('News.name',array('value'=> $edit_vie['News']['name'],'class'=>'text-input medium-input','maxlength' => '250','id' => 'idtitle'));?></td>
                </tr>
				 ...
				 <tr>
                    ...
                    <td>
                        <select name="data[News][cat_id]" id="jumpMenu">
                            ...
                            <option value="<?php echo $k; ?>" <?php if($edit_vie['News']['cat_id'] == $k) {echo 'selected="selected"';} ?>><?php echo $v; ?></option>
                            <?php } ?>
                        </select>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input name="oldimg" type="hidden" id="imgid" value="<?php echo $edit_vie['News']['images']; ?>">
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><?php echo $this->Form->input('News.title_seo',array('label'=>'','class'=>'text-input medium-input','maxlength' => '250','id' => 'idtitle',  'inputDefaults' => array('label' => false,'div' => false)));?></td>
                </tr>
                <tr>
