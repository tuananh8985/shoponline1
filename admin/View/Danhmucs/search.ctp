<?php echo $form->create(null, array( 'url' => DOMAINAD.'danhmucs/search','type' => 'post','enctype'=>'multipart/form-data','name'=>'image')); ?> 
<div id="khung">
	<div id="main">
		<div class="toolbar-list" id="toolbar">
                    <ul>
                        <li id="toolbar-new">
                            <a href="<?php echo DOMAINAD?>danhmucs/add" class="toolbar">
                ...
                <tbody>
                   <?php $i=1; foreach ($listsearch as $key =>$value){?>
                    <tr>
                        ...
                        <td><a href="<?php echo DOMAINAD?>danhmucs/edit/<?php echo $value['Danhmuc']['id'] ?>" title="Edit">
							<?php 
							
								echo $value['Danhmuc']['name'];?>
                            </a>
                        </td>
                         <td>
							<?php echo $value['ParentCat']['name'];?>
                        </td>
                        <td style="text-align:center;"><input class="text-input medium-input datepicker" style="text-align:center; width:30% !important;" type="text" value="<?php echo $value['Danhmuc']['order'];?>" name="order" /></td>
                        <td><?php echo date('d-m-Y h:i:s', strtotime($value['Danhmuc']['modified'])); ?></td>
                        <?php if($value['Danhmuc']['status']==0){?>  
                        <td>
                             <a href="<?php echo DOMAINAD?>danhmucs/edit/<?php echo $value['Danhmuc']['id'] ?>" title="Sửa mục này"><img src="<?php echo DOMAINAD?>images/icons/pencil.png" alt="Sửa" /></a>
                             <a href="javascript:confirmDelete('<?php echo DOMAINAD?>danhmucs/delete/<?php echo $value['Danhmuc']['id'] ?>')" title="Xóa mục này"><img src="<?php echo DOMAINAD?>images/icons/cross.png" alt="Xóa" /></a> 
                        ...
                        <?php } else {?> 
                          <td>
                            <!-- Icons -->
                             <a href="<?php echo DOMAINAD?>danhmucs/edit/<?php echo $value['Danhmuc']['id'] ?>" title="Sửa mục này"><img src="<?php echo DOMAINAD?>images/icons/pencil.png" alt="Sửa" /></a>
                             <a href="javascript:confirmDelete('<?php echo DOMAINAD?>danhmucs/delete/<?php echo $value['Danhmuc']['id'] ?>')" title="Xóa mục này"><img src="<?php echo DOMAINAD?>images/icons/cross.png" alt="Xóa" /></a> 
                             <a href="<?php echo DOMAINAD?>danhmucs/close/<?php echo $value['Danhmuc']['id'] ?>" title="Tích vào để không hiển thị mục này" class="icon-4 info-tooltip"><img src="<?php echo DOMAINAD?>images/icons/success-icon.png" alt="Ngắt kích hoạt" /></a>
                        </td>
