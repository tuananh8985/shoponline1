            ...
            <table class="input">
			   ...
			   <tr>
				  ...
				  <tr>
                    ...
                    <td>
                     <input type="text" size="50" style="height:25px;"  name="userfile1" readonly="true"> &nbsp;<a href="javascript:window.open('<?php echo DOMAINAD; ?>upload_multi_noresize.php?stt=3','userfile3','width=500,height=300');window.history.go(1)" ><input type="button" value="Chọn ảnh" class="button" /></a>
