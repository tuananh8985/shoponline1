...
<div class="content-box">
            ...
            <table width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align:center;"><img src="<?php echo DOMAINAD; ?><?php echo $value['Product']['images']; ?>" height="100"></td>
                            <td><a href="<?php echo DOMAINAD ?>products/edit/<?php echo $value['Product']['id']; ?>" title="Edit"><?php echo $value['Product']['name']; ?></a> 
							<?php if(date('Y-m-d', strtotime($value['Product']['modified'])) == date('Y-m-d')) { ?><img src="<?php echo DOMAINAD ?>images/icons/iconnew.gif" alt="Product" /><?php } ?></td>
	...
	<td>
			  ...
			  <td><?php echo date('d-m-Y', strtotime($value['Product']['modified'])); ?></td>
                            <td><a href="<?php echo DOMAINAD ?>products/edit/<?php echo $value['Product']['id']; ?>" title="Edit"><img src="<?php echo DOMAINAD ?>images/icons/pencil.png" alt="Edit" /></a> <a href="javascript:confirmDelete('<?php echo DOMAINAD ?>products/delete/<?php echo $value['Product']['id']; ?>')" title="Delete"><img src="<?php echo DOMAINAD ?>images/icons/cross.png" alt="Delete" /></a>
                                <?php
