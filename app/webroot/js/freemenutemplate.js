...
// $("#secondpane p.menu_head1").mouseover(function(){
// $(this).css({backgroundImage:"url(<?php echo DOMAIN?>images/mt1.png)"}).next("div.menu_body1").slideDown(500).siblings("div.menu_body1").slideUp("slow");
...
$(this).css({backgroundImage:"url(none)"}).next("div.menu_body").slideToggle(300).siblings("div.menu_body").slideUp("slow");
//$(this).siblings().css({backgroundImage:"url(images/left.png)"});
});

$("#secondpane p.menu_head").mouseover(function(){
$(this).css({backgroundImage:"none"}).next("div.menu_body").slideDown(500).siblings("div.menu_body").slideUp("slow");
//$(this).siblings().css({backgroundImage:"url(images/left.png)"});
});
});
...
$(this).css({backgroundImage:"none"}).next("div.menu_body2").slideDown(500).siblings("div.menu_body2").slideUp("slow");
$(this).siblings().css({backgroundImage:"url(images/left2.png)"});
});
});
